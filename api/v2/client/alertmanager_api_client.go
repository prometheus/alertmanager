...
import (
	...
	"github.com/prometheus/alertmanager/api/v2/client/alertgroupinfos"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *AlertmanagerAPI {
	...
	cli.Alertgroupinfos = alertgroupinfos.New(transport, formats)
...
type AlertmanagerAPI struct {
	...
	Alertgroupinfos alertgroupinfos.ClientService
...
func (c *AlertmanagerAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.Alertgroupinfos.SetTransport(transport)
