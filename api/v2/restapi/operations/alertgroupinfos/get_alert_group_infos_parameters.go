...
// GetAlertGroupInfosParams contains all the bound params for the get alert group infos operation
// typically these are obtained from a http.Request
//
// swagger:parameters getAlertGroupInfos
...
//
// To ensure default values, the struct must have been initialized with NewGetAlertGroupInfosParams() beforehand.
func (o *GetAlertGroupInfosParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAlertGroupInfosParams) bindMaxResults(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAlertGroupInfosParams) bindNextToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAlertGroupInfosParams) bindReceiver(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
