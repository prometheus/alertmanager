...
// GetAlertInfosURL generates an URL for the get alert infos operation
...
func (o *GetAlertInfosURL) WithBasePath(bp string) *GetAlertInfosURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *GetAlertInfosURL) SetBasePath(bp string) {
	o._basePath = bp
}

// Build a url path and query string
func (o *GetAlertInfosURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/alertinfos"
...
func (o *GetAlertInfosURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *GetAlertInfosURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *GetAlertInfosURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAlertInfosURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAlertInfosURL")
	}
...
func (o *GetAlertInfosURL) StringFull(scheme, host string) string {
