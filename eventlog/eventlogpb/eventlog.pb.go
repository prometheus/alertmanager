...
func (NotifyReason) Descriptor() protoreflect.EnumDescriptor {
	return file_eventlog_proto_enumTypes[0].Descriptor()
}

func (NotifyReason) Type() protoreflect.EnumType {
	return &file_eventlog_proto_enumTypes[0]
}
...
func (Matcher_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_eventlog_proto_enumTypes[1].Descriptor()
}

func (Matcher_Type) Type() protoreflect.EnumType {
	return &file_eventlog_proto_enumTypes[1]
}
...
func (Matcher_Type) EnumDescriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{15, 0}
}

// Event is the top-level envelope written to each event log output.
...
// EventData carries the payload for a single event log entry.
...
func (x *LabelPair) Reset() {
	*x = LabelPair{}
	mi := &file_eventlog_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LabelPair) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{4}
}
...
func (x *LabelSet) Reset() {
	*x = LabelSet{}
	mi := &file_eventlog_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LabelSet) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{5}
}
...
func (x *Alert) Reset() {
	*x = Alert{}
	mi := &file_eventlog_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Alert) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{6}
}
...
func (x *GroupedAlert) Reset() {
	*x = GroupedAlert{}
	mi := &file_eventlog_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GroupedAlert) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{7}
}
...
type AlertGroupInfo struct {
	...
	// Labels defined on the route itself (distinct from group labels).
	RouteLabels *LabelSet `protobuf:"bytes,6,opt,name=route_labels,json=routeLabels,proto3" json:"route_labels,omitempty"`
	// A UUID that uniquely identifies this aggregation group instance.
	GroupUuid     string `protobuf:"bytes,7,opt,name=group_uuid,json=groupUuid,proto3" json:"group_uuid,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AlertGroupInfo) Reset() {
	*x = AlertGroupInfo{}
	mi := &file_eventlog_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlertGroupInfo) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{8}
}
...
func (x *AlertGroupInfo) GetRouteLabels() *LabelSet {
	if x != nil {
...
func (x *AlertCreatedEvent) Reset() {
	*x = AlertCreatedEvent{}
	mi := &file_eventlog_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlertCreatedEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{9}
}
...
func (x *AlertResolvedEvent) Reset() {
	*x = AlertResolvedEvent{}
	mi := &file_eventlog_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlertResolvedEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{10}
}
...
func (x *AlertGroupedEvent) Reset() {
	*x = AlertGroupedEvent{}
	mi := &file_eventlog_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AlertGroupedEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{11}
}
...
func (x *Integration) Reset() {
	*x = Integration{}
	mi := &file_eventlog_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Integration) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{12}
}
...
type NotificationEvent struct {
	...
	Reason NotifyReason `protobuf:"varint,7,opt,name=reason,proto3,enum=eventlog.NotifyReason" json:"reason,omitempty"`
...
func (x *NotificationEvent) Reset() {
	*x = NotificationEvent{}
	mi := &file_eventlog_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NotificationEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{13}
}
...
func (x *Silence) Reset() {
	*x = Silence{}
	mi := &file_eventlog_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Silence) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{14}
}
...
type Matcher struct {
	...
	Type Matcher_Type `protobuf:"varint,1,opt,name=type,proto3,enum=eventlog.Matcher_Type" json:"type,omitempty"`
...
func (x *Matcher) Reset() {
	*x = Matcher{}
	mi := &file_eventlog_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Matcher) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{15}
}
...
func (x *MatcherSet) Reset() {
	*x = MatcherSet{}
	mi := &file_eventlog_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MatcherSet) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{16}
}
...
func (x *SilenceCreatedEvent) Reset() {
	*x = SilenceCreatedEvent{}
	mi := &file_eventlog_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SilenceCreatedEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{17}
}
...
func (x *SilenceUpdatedEvent) Reset() {
	*x = SilenceUpdatedEvent{}
	mi := &file_eventlog_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SilenceUpdatedEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{18}
}
...
func (x *MutedAlert) Reset() {
	*x = MutedAlert{}
	mi := &file_eventlog_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutedAlert) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{19}
}
...
func (x *SilenceMutedAlertEvent) Reset() {
	*x = SilenceMutedAlertEvent{}
	mi := &file_eventlog_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SilenceMutedAlertEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{20}
}
...
func (x *InhibitRule) Reset() {
	*x = InhibitRule{}
	mi := &file_eventlog_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InhibitRule) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{21}
}
...
func (x *InhibitionMutedAlertEvent) Reset() {
	*x = InhibitionMutedAlertEvent{}
	mi := &file_eventlog_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InhibitionMutedAlertEvent) Descriptor() ([]byte, []int) {
	return file_eventlog_proto_rawDescGZIP(), []int{22}
}
...
const file_eventlog_proto_rawDesc = "" +
	"\n" +
	"\x0eeventlog.proto\x12\beventlog\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb2\x01\n" +
	"\x05Event\x129\n" +
	"\ttimestamp\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"@timestamp\x12\x1a\n" +
	"\binstance\x18\x02 \x01(\tR\binstance\x12'\n" +
	"\x04data\x18\x03 \x01(\v2\x13.eventlog.EventDataR\x04data\x12)\n" +
	"\x10cluster_position\x18\x04 \x01(\rR\x0fclusterPosition\"\xbb\x06\n" +
	"\tEventData\x12b\n" +
	"\x1aalertmanager_startup_event\x18\x01 \x01(\v2\".eventlog.AlertmanagerStartupEventH\x00R\x18alertmanagerStartupEvent\x12e\n" +
	"\x1balertmanager_shutdown_event\x18\x02 \x01(\v2#.eventlog.AlertmanagerShutdownEventH\x00R\x19alertmanagerShutdownEvent\x12B\n" +
	"\ralert_created\x18\x03 \x01(\v2\x1b.eventlog.AlertCreatedEventH\x00R\falertCreated\x12E\n" +
	"\x0ealert_resolved\x18\x04 \x01(\v2\x1c.eventlog.AlertResolvedEventH\x00R\ralertResolved\x12B\n" +
	"\ralert_grouped\x18\x05 \x01(\v2\x1b.eventlog.AlertGroupedEventH\x00R\falertGrouped\x12A\n" +
	"\fnotification\x18\x06 \x01(\v2\x1b.eventlog.NotificationEventH\x00R\fnotification\x12H\n" +
	"\x0fsilence_created\x18\a \x01(\v2\x1d.eventlog.SilenceCreatedEventH\x00R\x0esilenceCreated\x12H\n" +
	"\x0fsilence_updated\x18\b \x01(\v2\x1d.eventlog.SilenceUpdatedEventH\x00R\x0esilenceUpdated\x12R\n" +
	"\x13silence_muted_alert\x18\t \x01(\v2 .eventlog.SilenceMutedAlertEventH\x00R\x11silenceMutedAlert\x12[\n" +
	"\x16inhibition_muted_alert\x18\n" +
	" \x01(\v2#.eventlog.InhibitionMutedAlertEventH\x00R\x14inhibitionMutedAlertB\f\n" +
	"\n" +
	"event_type\"Y\n" +
	...
	"\bLabelSet\x12+\n" +
	"\x06labels\x18\x01 \x03(\v2\x13.eventlog.LabelPairR\x06labels\"\xa9\x02\n" +
	"\x05Alert\x12 \n" +
	"\vfingerprint\x18\x01 \x01(\x04R\vfingerprint\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12*\n" +
	"\x06labels\x18\x03 \x01(\v2\x12.eventlog.LabelSetR\x06labels\x124\n" +
	"\vannotations\x18\x04 \x01(\v2\x12.eventlog.LabelSetR\vannotations\x127\n" +
	...
	"\bresolved\x18\a \x01(\bR\bresolved\"^\n" +
	"\fGroupedAlert\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\x04R\x04hash\x12.\n" +
	"\adetails\x18\x02 \x01(\v2\x0f.eventlog.AlertH\x00R\adetails\x88\x01\x01B\n" +
	"\n" +
	"\b_details\"\xa9\x02\n" +
	"\x0eAlertGroupInfo\x12\x1b\n" +
	"\tgroup_key\x18\x01 \x01(\tR\bgroupKey\x125\n" +
	"\fgroup_labels\x18\x02 \x01(\v2\x12.eventlog.LabelSetR\vgroupLabels\x12\x19\n" +
	"\bgroup_id\x18\x03 \x01(\tR\agroupId\x12#\n" +
	"\rreceiver_name\x18\x04 \x01(\tR\freceiverName\x12-\n" +
	"\bmatchers\x18\x05 \x03(\v2\x11.eventlog.MatcherR\bmatchers\x125\n" +
	"\froute_labels\x18\x06 \x01(\v2\x12.eventlog.LabelSetR\vrouteLabels\x12\x1d\n" +
	"\n" +
	"group_uuid\x18\a \x01(\tR\tgroupUuid\":\n" +
	"\x11AlertCreatedEvent\x12%\n" +
	"\x05alert\x18\x01 \x01(\v2\x0f.eventlog.AlertR\x05alert\"{\n" +
	"\x12AlertResolvedEvent\x12,\n" +
	"\x05alert\x18\x01 \x01(\v2\x16.eventlog.GroupedAlertR\x05alert\x127\n" +
	"\n" +
	"group_info\x18\x02 \x01(\v2\x18.eventlog.AlertGroupInfoR\tgroupInfo\"z\n" +
	"\x11AlertGroupedEvent\x12,\n" +
	"\x05alert\x18\x01 \x01(\v2\x16.eventlog.GroupedAlertR\x05alert\x127\n" +
	"\n" +
	"group_info\x18\x02 \x01(\v2\x18.eventlog.AlertGroupInfoR\tgroupInfo\"7\n" +
	"\vIntegration\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05index\x18\x02 \x01(\x03R\x05index\"\xfd\x03\n" +
	"\x11NotificationEvent\x12.\n" +
	"\x06alerts\x18\x01 \x03(\v2\x16.eventlog.GroupedAlertR\x06alerts\x12;\n" +
	"\rfiring_alerts\x18\x02 \x03(\v2\x16.eventlog.GroupedAlertR\ffiringAlerts\x12?\n" +
	"\x0fresolved_alerts\x18\x03 \x03(\v2\x16.eventlog.GroupedAlertR\x0eresolvedAlerts\x129\n" +
	"\fmuted_alerts\x18\x04 \x03(\v2\x16.eventlog.GroupedAlertR\vmutedAlerts\x127\n" +
	"\n" +
	"group_info\x18\x05 \x01(\v2\x18.eventlog.AlertGroupInfoR\tgroupInfo\x12B\n" +
	"\x0frepeat_interval\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\x0erepeatInterval\x12.\n" +
	"\x06reason\x18\a \x01(\x0e2\x16.eventlog.NotifyReasonR\x06reason\x12\x19\n" +
	"\bflush_id\x18\b \x01(\x04R\aflushId\x127\n" +
	"\vintegration\x18\t \x01(\v2\x15.eventlog.IntegrationR\vintegration\"\x99\x03\n" +
	"\aSilence\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12-\n" +
	"\bmatchers\x18\x02 \x03(\v2\x11.eventlog.MatcherR\bmatchers\x124\n" +
	"\vannotations\x18\x03 \x01(\v2\x12.eventlog.LabelSetR\vannotations\x127\n" +
	...
	"\fmatcher_sets\x18\t \x03(\v2\x14.eventlog.MatcherSetR\vmatcherSets\"\xe7\x01\n" +
	"\aMatcher\x12*\n" +
	"\x04type\x18\x01 \x01(\x0e2\x16.eventlog.Matcher.TypeR\x04type\x12\x12\n" +
	...
	"\n" +
	"MatcherSet\x12-\n" +
	"\bmatchers\x18\x01 \x03(\v2\x11.eventlog.MatcherR\bmatchers\"B\n" +
	"\x13SilenceCreatedEvent\x12+\n" +
	"\asilence\x18\x01 \x01(\v2\x11.eventlog.SilenceR\asilence\"B\n" +
	"\x13SilenceUpdatedEvent\x12+\n" +
	"\asilence\x18\x01 \x01(\v2\x11.eventlog.SilenceR\asilence\"Z\n" +
	"\n" +
	"MutedAlert\x12*\n" +
	"\x06labels\x18\x01 \x01(\v2\x12.eventlog.LabelSetR\x06labels\x12 \n" +
	"\vfingerprint\x18\x02 \x01(\x04R\vfingerprint\"|\n" +
	"\x16SilenceMutedAlertEvent\x12+\n" +
	"\asilence\x18\x01 \x01(\v2\x11.eventlog.SilenceR\asilence\x125\n" +
	"\vmuted_alert\x18\x02 \x01(\v2\x14.eventlog.MutedAlertR\n" +
	"mutedAlert\"\xa8\x01\n" +
	"\vInhibitRule\x12:\n" +
	"\x0fsource_matchers\x18\x01 \x03(\v2\x11.eventlog.MatcherR\x0esourceMatchers\x12:\n" +
	"\x0ftarget_matchers\x18\x02 \x03(\v2\x11.eventlog.MatcherR\x0etargetMatchers\x12!\n" +
	"\fequal_labels\x18\x03 \x03(\tR\vequalLabels\"\xc7\x01\n" +
	"\x19InhibitionMutedAlertEvent\x12:\n" +
	"\rinhibit_rules\x18\x01 \x03(\v2\x15.eventlog.InhibitRuleR\finhibitRules\x125\n" +
	"\vmuted_alert\x18\x02 \x01(\v2\x14.eventlog.MutedAlertR\n" +
	"mutedAlert\x127\n" +
	...
	"%NOTIFY_REASON_REPEAT_INTERVAL_ELAPSED\x10\x05B8Z6github.com/prometheus/alertmanager/eventlog/eventlogpbb\x06proto3"

var (
	file_eventlog_proto_rawDescOnce sync.Once
	file_eventlog_proto_rawDescData []byte
)

func file_eventlog_proto_rawDescGZIP() []byte {
	file_eventlog_proto_rawDescOnce.Do(func() {
		file_eventlog_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eventlog_proto_rawDesc), len(file_eventlog_proto_rawDesc)))
	})
	return file_eventlog_proto_rawDescData
}

var file_eventlog_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_eventlog_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_eventlog_proto_goTypes = []any{
	(NotifyReason)(0),                 // 0: eventlog.NotifyReason
	(Matcher_Type)(0),                 // 1: eventlog.Matcher.Type
	(*Event)(nil),                     // 2: eventlog.Event
	(*EventData)(nil),                 // 3: eventlog.EventData
	(*AlertmanagerStartupEvent)(nil),  // 4: eventlog.AlertmanagerStartupEvent
	(*AlertmanagerShutdownEvent)(nil), // 5: eventlog.AlertmanagerShutdownEvent
	(*LabelPair)(nil),                 // 6: eventlog.LabelPair
	(*LabelSet)(nil),                  // 7: eventlog.LabelSet
	(*Alert)(nil),                     // 8: eventlog.Alert
	(*GroupedAlert)(nil),              // 9: eventlog.GroupedAlert
	(*AlertGroupInfo)(nil),            // 10: eventlog.AlertGroupInfo
	(*AlertCreatedEvent)(nil),         // 11: eventlog.AlertCreatedEvent
	(*AlertResolvedEvent)(nil),        // 12: eventlog.AlertResolvedEvent
	(*AlertGroupedEvent)(nil),         // 13: eventlog.AlertGroupedEvent
	(*Integration)(nil),               // 14: eventlog.Integration
	(*NotificationEvent)(nil),         // 15: eventlog.NotificationEvent
	(*Silence)(nil),                   // 16: eventlog.Silence
	(*Matcher)(nil),                   // 17: eventlog.Matcher
	(*MatcherSet)(nil),                // 18: eventlog.MatcherSet
	(*SilenceCreatedEvent)(nil),       // 19: eventlog.SilenceCreatedEvent
	(*SilenceUpdatedEvent)(nil),       // 20: eventlog.SilenceUpdatedEvent
	(*MutedAlert)(nil),                // 21: eventlog.MutedAlert
	(*SilenceMutedAlertEvent)(nil),    // 22: eventlog.SilenceMutedAlertEvent
	(*InhibitRule)(nil),               // 23: eventlog.InhibitRule
	(*InhibitionMutedAlertEvent)(nil), // 24: eventlog.InhibitionMutedAlertEvent
	(*timestamppb.Timestamp)(nil),     // 25: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),       // 26: google.protobuf.Duration
}
var file_eventlog_proto_depIdxs = []int32{
	25, // 0: eventlog.Event.timestamp:type_name -> google.protobuf.Timestamp
	3,  // 1: eventlog.Event.data:type_name -> eventlog.EventData
	4,  // 2: eventlog.EventData.alertmanager_startup_event:type_name -> eventlog.AlertmanagerStartupEvent
	5,  // 3: eventlog.EventData.alertmanager_shutdown_event:type_name -> eventlog.AlertmanagerShutdownEvent
	11, // 4: eventlog.EventData.alert_created:type_name -> eventlog.AlertCreatedEvent
	12, // 5: eventlog.EventData.alert_resolved:type_name -> eventlog.AlertResolvedEvent
	13, // 6: eventlog.EventData.alert_grouped:type_name -> eventlog.AlertGroupedEvent
	15, // 7: eventlog.EventData.notification:type_name -> eventlog.NotificationEvent
	19, // 8: eventlog.EventData.silence_created:type_name -> eventlog.SilenceCreatedEvent
	20, // 9: eventlog.EventData.silence_updated:type_name -> eventlog.SilenceUpdatedEvent
	22, // 10: eventlog.EventData.silence_muted_alert:type_name -> eventlog.SilenceMutedAlertEvent
	24, // 11: eventlog.EventData.inhibition_muted_alert:type_name -> eventlog.InhibitionMutedAlertEvent
	6,  // 12: eventlog.LabelSet.labels:type_name -> eventlog.LabelPair
	7,  // 13: eventlog.Alert.labels:type_name -> eventlog.LabelSet
	7,  // 14: eventlog.Alert.annotations:type_name -> eventlog.LabelSet
	25, // 15: eventlog.Alert.starts_at:type_name -> google.protobuf.Timestamp
	25, // 16: eventlog.Alert.ends_at:type_name -> google.protobuf.Timestamp
	8,  // 17: eventlog.GroupedAlert.details:type_name -> eventlog.Alert
	7,  // 18: eventlog.AlertGroupInfo.group_labels:type_name -> eventlog.LabelSet
	17, // 19: eventlog.AlertGroupInfo.matchers:type_name -> eventlog.Matcher
	7,  // 20: eventlog.AlertGroupInfo.route_labels:type_name -> eventlog.LabelSet
	8,  // 21: eventlog.AlertCreatedEvent.alert:type_name -> eventlog.Alert
	9,  // 22: eventlog.AlertResolvedEvent.alert:type_name -> eventlog.GroupedAlert
	10, // 23: eventlog.AlertResolvedEvent.group_info:type_name -> eventlog.AlertGroupInfo
	9,  // 24: eventlog.AlertGroupedEvent.alert:type_name -> eventlog.GroupedAlert
	10, // 25: eventlog.AlertGroupedEvent.group_info:type_name -> eventlog.AlertGroupInfo
	9,  // 26: eventlog.NotificationEvent.alerts:type_name -> eventlog.GroupedAlert
	9,  // 27: eventlog.NotificationEvent.firing_alerts:type_name -> eventlog.GroupedAlert
	9,  // 28: eventlog.NotificationEvent.resolved_alerts:type_name -> eventlog.GroupedAlert
	9,  // 29: eventlog.NotificationEvent.muted_alerts:type_name -> eventlog.GroupedAlert
	10, // 30: eventlog.NotificationEvent.group_info:type_name -> eventlog.AlertGroupInfo
	26, // 31: eventlog.NotificationEvent.repeat_interval:type_name -> google.protobuf.Duration
	0,  // 32: eventlog.NotificationEvent.reason:type_name -> eventlog.NotifyReason
	14, // 33: eventlog.NotificationEvent.integration:type_name -> eventlog.Integration
	17, // 34: eventlog.Silence.matchers:type_name -> eventlog.Matcher
	7,  // 35: eventlog.Silence.annotations:type_name -> eventlog.LabelSet
	25, // 36: eventlog.Silence.starts_at:type_name -> google.protobuf.Timestamp
	25, // 37: eventlog.Silence.ends_at:type_name -> google.protobuf.Timestamp
	25, // 38: eventlog.Silence.updated_at:type_name -> google.protobuf.Timestamp
	18, // 39: eventlog.Silence.matcher_sets:type_name -> eventlog.MatcherSet
	1,  // 40: eventlog.Matcher.type:type_name -> eventlog.Matcher.Type
	17, // 41: eventlog.MatcherSet.matchers:type_name -> eventlog.Matcher
	16, // 42: eventlog.SilenceCreatedEvent.silence:type_name -> eventlog.Silence
	16, // 43: eventlog.SilenceUpdatedEvent.silence:type_name -> eventlog.Silence
	7,  // 44: eventlog.MutedAlert.labels:type_name -> eventlog.LabelSet
	16, // 45: eventlog.SilenceMutedAlertEvent.silence:type_name -> eventlog.Silence
	21, // 46: eventlog.SilenceMutedAlertEvent.muted_alert:type_name -> eventlog.MutedAlert
	17, // 47: eventlog.InhibitRule.source_matchers:type_name -> eventlog.Matcher
	17, // 48: eventlog.InhibitRule.target_matchers:type_name -> eventlog.Matcher
	23, // 49: eventlog.InhibitionMutedAlertEvent.inhibit_rules:type_name -> eventlog.InhibitRule
	21, // 50: eventlog.InhibitionMutedAlertEvent.muted_alert:type_name -> eventlog.MutedAlert
...
func file_eventlog_proto_init() {
	...
	file_eventlog_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_eventlog_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eventlog_proto_rawDesc), len(file_eventlog_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   23,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_eventlog_proto_enumTypes,
