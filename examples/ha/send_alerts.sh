...
curl -XPOST -d"$alerts1" http://localhost:9093/api/v2/alerts
curl -XPOST -d"$alerts1" http://localhost:9094/api/v2/alerts
curl -XPOST -d"$alerts1" http://localhost:9095/api/v2/alerts
