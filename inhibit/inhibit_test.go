...
func TestInhibitRuleMatchers(t *testing.T) {
	...
	rule1 := config.InhibitRule{
		SourceMatchers: config.Matchers{&matcher.Matcher{Type: matcher.MatchEqual, Name: "s1", Value: "1"}},
		TargetMatchers: config.Matchers{&matcher.Matcher{Type: matcher.MatchNotEqual, Name: "t1", Value: "1"}},
		Equal:          model.LabelNames{"e"},
	}
	rule2 := config.InhibitRule{
		SourceMatchers: config.Matchers{&matcher.Matcher{Type: matcher.MatchEqual, Name: "s2", Value: "1"}},
		TargetMatchers: config.Matchers{&matcher.Matcher{Type: matcher.MatchEqual, Name: "t2", Value: "1"}},
		Equal:          model.LabelNames{"e"},
	}
