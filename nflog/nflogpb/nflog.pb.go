...
type Entry struct {
	...
	// Store threaded state for a notification
	ThreadedState        map[string]string `protobuf:"bytes,8,rep,name=threaded_state,json=threadedState,proto3" json:"threaded_state,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "nflogpb.Entry.ThreadedStateEntry")
...
var fileDescriptor_c2d9785ad9c3e602 = []byte{
	...
	,
}
...
func (m *Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ThreadedState) > 0 {
		for k := range m.ThreadedState {
			v := m.ThreadedState[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintNflog(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
...
func (m *Entry) Size() (n int) {
	...
	if len(m.ThreadedState) > 0 {
		for k, v := range m.ThreadedState {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovNflog(uint64(len(k))) + 1 + len(v) + sovNflog(uint64(len(v)))
...
func (m *Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ThreadedState", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ThreadedState == nil {
				m.ThreadedState = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.ThreadedState[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipNflog(dAtA[iNdEx:])
