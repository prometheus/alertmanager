...
func TestNewRelicRetry(t *testing.T) {
	notifier, err := New(
...
func TestNewRelicRedactedURL(t *testing.T) {
...
func TestNewRelic(t *testing.T) {
	u, err := url.Parse("https://log-api.newrelic.com/log/v1")
	if err != nil {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			expectedEmptyAlertBody: `{"nridomain":"NewRelicReceiver1","alias":"6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b","message":"","details":{},"source":""}
`,
			expectedBody: `{"nridomain":"NewRelicReceiver1","alias":"6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b","message":"message","description":"description","details":{"Description":"description","Message":"message","Note":"this is a note","Priority":"P1","Source":"http://prometheus","Tags":"tag1,tag2"},"source":"http://prometheus","tags":["tag1","tag2"],"note":"this is a note","priority":"P1"}
`,
		},
		{
			...
			expectedEmptyAlertBody: `{"nridomain":"NewRelicReceiver1","alias":"6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b","message":"","details":{"Description":"adjusted "},"source":""}
`,
...
`,
		...
		t.Run(tc.title, func(t *testing.T) {
			...
			expectedURL, _ := url.Parse("https://log-api.newrelic.com/log/v1")
			...
			require.Equal(t, "http://am", req.Header.Get("Api-Key"))
