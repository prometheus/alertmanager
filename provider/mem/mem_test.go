...
func TestAlertsSubscribePutStarvation(t *testing.T) {
	alerts, err := NewAlerts(context.Background(), 30*time.Minute, 0, noopCallback{}, promslog.NewNopLogger(), prometheus.NewRegistry(), nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestDeadLock(t *testing.T) {
	...
	alerts, err := NewAlerts(context.Background(), 5*time.Millisecond, 0, noopCallback{}, promslog.NewNopLogger(), prometheus.NewRegistry(), nil)
	if err != nil {
		t.Fatal(err)
	}
	alertsToInsert := []*types.Alert{}
...
func TestAlertsSubscribe(t *testing.T) {
	ctx := t.Context()
	alerts, err := NewAlerts(ctx, 30*time.Minute, 0, noopCallback{}, promslog.NewNopLogger(), prometheus.NewRegistry(), nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAlertsGetPending(t *testing.T) {
	alerts, err := NewAlerts(context.Background(), 30*time.Minute, 0, noopCallback{}, promslog.NewNopLogger(), nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAlertsGC(t *testing.T) {
	alerts, err := NewAlerts(context.Background(), 200*time.Millisecond, 0, noopCallback{}, promslog.NewNopLogger(), nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAlertsStoreCallback(t *testing.T) {
	...
	alerts, err := NewAlerts(context.Background(), 200*time.Millisecond, 0, cb, promslog.NewNopLogger(), nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestAlertsConcurrently(t *testing.T) {
	...
	a, err := NewAlerts(context.Background(), time.Millisecond, 0, callback, promslog.NewNopLogger(), nil, nil)
...
func TestSubscriberChannelMetrics(t *testing.T) {
	...
	alerts, err := NewAlerts(context.Background(), 30*time.Minute, 0, noopCallback{}, promslog.NewNopLogger(), reg, nil)
	require.NoError(t, err)
