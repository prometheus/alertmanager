...
func templateDefaultTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "template/default.tmpl", size: 15490, mode: os.FileMode(420), modTime: time.Unix(1460115944, 0)}
