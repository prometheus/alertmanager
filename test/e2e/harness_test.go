...
// statusClient returns a StatusService client for the instance. The RPC
// surface is mounted under the version-neutral /api/ prefix.
func (i *instance) statusClient(opts ...connect.ClientOption) statusv3connect.StatusServiceClient {
	return statusv3connect.NewStatusServiceClient(http.DefaultClient, i.baseURL+"/api", opts...)
}
